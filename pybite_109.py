...
# _HINTS_
# dict(), exception handling, format, string manipulation, ternary

# _DESCRIPTION_

# In this Bite you learn how to lookup values from a dictionary or in Python: dict.
# You are presented with workout_schedule 
#     with keys: days and values: workouts. 
...
#     we don't want this function to continue, the caller needs to catch this exception.
